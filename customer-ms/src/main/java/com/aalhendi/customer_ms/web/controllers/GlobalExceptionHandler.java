...
import com.aalhendi.customer_ms.web.dtos.ErrorResponse;
...
/**
 * Global exception handler for the customer microservice.
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles all business exceptions using the sealed class hierarchy.
